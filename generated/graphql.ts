...
export type EducationWhereInput = {
  ...
  /** Matches if the field matches any of the given values. */
  related_link_text_any?: InputMaybe<
  ...
  /** Matches if the field matches any of the given values. */
  related_link_url_any?: InputMaybe<
    Array<InputMaybe<Scalars["String"]["input"]>>
  >;
  /** Full fuzzy text search, not case sensitive. */
...
export type GetArticlesQueryQuery = {
  Articles?: {
    total: number;
    items: Array<{
      _id: string;
...
export type GetArticleQueryQuery = {
  Article?: {
    title?: string | null;
    description?: string | null;
    body?: string | null;
...
export const GetArticlesQueryDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "getArticlesQuery" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
  ...
  GetArticlesQueryQuery,
  GetArticlesQueryQueryVariables
>;
export const GetArticleQueryDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
...
export const GetPortfolioByIdDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "getPortfolioById" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
      ...
      variableDefinitions: [
        {
          ...
          type: {
            kind: "NamedType",
            name: { kind: "Name", value: "SkillSortInput" },
          },
        },
      ],
      selectionSet: {
...
export const GetEducationsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "getEducations" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "sort" } },
          type: {
            kind: "NamedType",
            name: { kind: "Name", value: "EducationSortInput" },
          },
        },
      ],
      selectionSet: {
              ...
              selections: [
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "related_link_text" },
                      },
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "related_link_url" },
                      },
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "start_end_date" },
                      },
                      {
                        kind: "Field",
...
} as unknown as DocumentNode<GetEducationsQuery, GetEducationsQueryVariables>;
