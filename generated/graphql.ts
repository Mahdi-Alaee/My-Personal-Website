...
export type GetSkillsQuery = { Skills?: { items: Array<{ _id: string, title?: string | null, percentage?: string | null, _publish_on?: string | null }> } | null };
